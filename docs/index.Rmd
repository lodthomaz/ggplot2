...
* É uma estrutura que segue uma abordagem para descrever e construir visualizações ou gráficos de maneira estruturada
...
```{r eval=FALSE, tidy=FALSE}
grafico + 
  scale_fill_brewer(name = "Temporada", palette = "Purples")
```
